...
var _can_fish = !defined(lure) && !exists(obj_catch_reward) && exists(obj_inventory) && !obj_inventory.show && 
	!obj_game_controller.paused && obj_game_controller.alarm[0] == -1 && exists(obj_sidebar_left) && !obj_sidebar_left.in_left &&
	!mouse_touching_edges() && exists(obj_shop) &&  !obj_shop.show && exists(obj_library) && !obj_library.show && 
