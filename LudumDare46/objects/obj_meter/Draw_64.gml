...
draw_sprite(spr_meter_arrow, 0, _x - 10, _y + height - (arrow_tick_pos * pixel_per_tick));
...
for (var i = goal_ticks + 1; i < ticks; i += pixel_per_tick)
	draw_sprite(spr_meter_tick, 0, _x, height - i * pixel_per_tick);
...
draw_sprite_ext(sprite, 0, _surf_x, _surf_y, _scale, _scale, 0, c_white, 1);