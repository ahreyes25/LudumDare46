/// @script			timer_reset_ext(owner, timer_index, pause_all);
/// @example		timer_reset_ext(id, 1, true);
...
/// @param reset_all?	-- boolean		-- required		-- example: true	-- effect every instance of the timer that's running? if only 1 timer instance is allowed, this arg is disregarded
