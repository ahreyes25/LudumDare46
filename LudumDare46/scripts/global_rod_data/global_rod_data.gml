...
global.rod_data[ROD.ROD_BASIC_1, RP.COST_SELL]		= 100 / obj_game_controller.multiplier;		
global.rod_data[ROD.ROD_BASIC_1, RP.COST_BUY]		= 100 / obj_game_controller.multiplier;		
...
global.rod_data[ROD.ROD_1, RP.COST_SELL]			= 50 / obj_game_controller.multiplier;
global.rod_data[ROD.ROD_1, RP.COST_BUY]				= 50 / obj_game_controller.multiplier;
...
global.rod_data[ROD.ROD_2, RP.COST_SELL]			= 250 / obj_game_controller.multiplier;
global.rod_data[ROD.ROD_2, RP.COST_BUY]				= 250 / obj_game_controller.multiplier;
...
global.rod_data[ROD.ROD_3, RP.COST_SELL]			= 500 / obj_game_controller.multiplier;
global.rod_data[ROD.ROD_3, RP.COST_BUY]				= 500 / obj_game_controller.multiplier;
...
global.rod_data[ROD.ROD_4, RP.COST_SELL]			= 1200 / obj_game_controller.multiplier;
global.rod_data[ROD.ROD_4, RP.COST_BUY]				= 1200 / obj_game_controller.multiplier;
...
global.rod_data[ROD.ROD_5, RP.COST_SELL]			= 2500 / obj_game_controller.multiplier;
global.rod_data[ROD.ROD_5, RP.COST_BUY]				= 2500 / obj_game_controller.multiplier;
