...
/// @description	return the number of iterations before timer destroys itself
/// @returns		integer, the number of iterations allowed
...
return _data[TIMER_PROP.MAX_ITERATIONS];