/// @script			timer_get_time_all(owner, timer_index, list);
/// @example		timer_get_time_all(id, 0, _my_list);
/// @description	gets the time of all active timer instances and puts them in a ds_list
